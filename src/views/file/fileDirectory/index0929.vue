...
<div>
    ...
    <el-dialog title="共享" :visible.sync="dialogFormVisible" :close-on-click-modal='false'>
        ...
        <el-form :model="form" style="margin-right: 30px; margin-top: 20px">
            ...
            <el-form-item label="共享内容" label-width="120px" v-if="shareData.type!=='1'">
                <el-input placeholder="请输入部门内容" class="input-with-select" v-if="shareData.type==='2'">
                    <el-button slot="prepend" @click="selectOrg">选择部门</el-button>
                </el-input>
                <el-input placeholder="请输入人员内容" class="input-with-select" v-if="shareData.type==='3'">
                    <el-button slot="prepend" @click="selectMen">选择人员</el-button>
                </el-input>
                <el-input placeholder="请输入角色内容" class="input-with-select" v-if="shareData.type==='4'">
                    <el-button slot="prepend" @click="selectRole">选择角色</el-button>
                </el-input>
            </el-form-item>

            <el-form-item label="安全级别" label-width="120px">
                <el-col :span="4">
                    <el-input v-model.number="shareData.startNo" autocomplete="off" type="number" oninput="value=value.replace(/[^\d.]/g,'')" />
                </el-col>
                <el-col :span="2" style="text-align: center">-</el-col>
                <el-col :span="4">
                    <el-input v-model.number="shareData.endNo" autocomplete="off" type="number" oninput="value=value.replace(/[^\d.]/g,'')" />
                </el-col>
            </el-form-item>
    ...
    <el-dialog title="选择部门" :visible.sync="dialogOrgVisible" :close-on-click-modal='false'>
        ...
        <el-pagination background :total="dataTotal" layout="prev, pager, next" :page-size="10" :current-page.sync="currentPage" @current-change="handleCurrentChangeOrg" />
    </el-dialog>
    <!--选择部门 结束-->
    ...
    <el-dialog title="选择人员" :visible.sync="dialogMenVisible" :close-on-click-modal='false'>
        ...
        <el-table ref="multipleTable" :data="tableData2" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChangeMen">
            ...
            <el-table-column label="所属组织单元" prop="department"> </el-table-column>
        ...
        <el-pagination background :total="dataTotal" layout="prev, pager, next" :page-size="10" :current-page.sync="currentPage" @current-change="handleCurrentChangeMen" />
    </el-dialog>
    <!--选择人员 结束-->
    ...
    <el-dialog title="选择人员" :visible.sync="dialogRoleVisible" :close-on-click-modal='false'>
        ...
        <el-pagination background :total="dataTotal" layout="prev, pager, next" :page-size="10" :current-page.sync="currentPage" @current-change="handleCurrentChangeRole" />
    </el-dialog>
    <!--选择角色 结束-->
