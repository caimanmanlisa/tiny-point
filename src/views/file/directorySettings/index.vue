      ...
      <div class="set_main_con">
        <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          <el-tab-pane label="基本信息" name="first">
            <basic-info :infoPropsData="infoData" :propsCheckId="checkId" @getFileDirectory="getFileDirectory" @freshenLoadNode="loadNode"/>
          </el-tab-pane>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      infoRules:{
        //验证目录名称是否合法
        lanVal:[ { required: true, message: '请输入目录名称', trigger: 'blur' }],
        //验证目录编码是否合法
  ...
  mounted() {
    this.$nextTick(() => {
      console.log('ref: ', this.$refs.treeNode)
    })
